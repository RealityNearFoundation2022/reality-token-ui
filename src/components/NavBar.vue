<template>
  <v-app-bar :elevation="2" color="black" app class="ma-0">
    <v-toolbar-title>
      <img src="/assets/logos/LogoOnelineWhite.png" :width="200" @click="scrollToSection('#description')"
    ...
    <v-app-bar-nav-icon class="d-flex d-sm-flex d-md-none" variant="text"
...
export default {
  ...
  data() {
    return {
      drawer: false,
      menuItems: [
        { id: 1, label: 'What is Reality Near?', path: '#description'  },
        { id: 2, label: 'Reality Token', path: '#about' },
